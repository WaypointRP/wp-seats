...
Config.Seats = {
	...
	prop_bench_07 = { model = "prop_bench_07", scenario = "PROP_HUMAN_SEAT_BENCH", offset = { x = 0.0, y = 0.0, z = 0.0, }, },
	...
	prop_chair_07 = { model = "prop_chair_07", scenario = "PROP_HUMAN_SEAT_BENCH", offset = { x = 0.0, y = 0.0, z = 0.0, }, },
	...
	uniqx_burgershot_seating01 = { model = "uniqx_burgershot_seating01", scenario = "PROP_HUMAN_SEAT_BENCH", offset = { x = 0.0, y = 0.0, z = 0.0, }, }, -- Chairs in BCSO Office infront of desk = { model = -212710979, scenario = 'PROP_HUMAN_SEAT_BENCH', offset = {x = 0.0, y = 0.0, z = 0.0}}, -- Chairs in BCSO Office infront of desk
}
